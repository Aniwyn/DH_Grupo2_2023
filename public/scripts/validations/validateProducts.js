...
function validateName() {
    ...
    if (gameName.value.length < 3 || gameName.value.length > 50) {
        ...
        inputGameName.innerHTML =
            "<span class=errorMessage>Debe contener entre 3 y 50 caracteres.</span>";
        return 1;
    }
...
function validateSubName() {
    let gameSubName = document.getElementById("f_subTitle");

    if (gameSubName.value.length < 3 || gameSubName.value.length > 30) {
        gameSubName.style.color = "red";
        let inputGameSubName = document.querySelector(
            "#container__inputGameSubName"
        );
        inputGameSubName.innerHTML =
            "<span class=errorMessage>Debe contener entre 3 y 30 caracteres.</span>";
        return 1;
    }
...
function validateFormat() {
    ...
    if (!flag) {
        ...
        inputFormat.innerHTML =
            "<span class=errorMessage>Debe seleccion al menos una opcion.</span>";
        return 1;
    }
...
function validatePlataform() {
    ...
    if (!flag) {
        let inputPlataform = document.querySelector(
            "#container__inputPlataform"
        );
        inputPlataform.innerHTML =
            "<span class=errorMessage>Debe seleccion al menos una opcion.</span>";
        return 1;
    }
...
function validateReleaseDate() {
    ...
    if (!releaseDate.value instanceof Date) {
        let inputReleaseDate = document.querySelector(
            "#container__inputReleaseDate"
        );
        inputReleaseDate.innerHTML =
            "<span class=errorMessage>Debe ingresar una fecha.</span>";
        return 1;
    }
...
function validateDeveloper() {
    ...
    if (developer.value.length < 3 || developer.value.length > 40) {
        ...
        inputDeveloper.innerHTML =
            "<span class=errorMessage>Debe contener entre 3 y 40 caracteres.</span>";
        return 1;
    }
...
function validateGenre() {
    ...
    if (!flag) {
        ...
        inputGenre.innerHTML =
            "<span class=errorMessage>Debe seleccionar al menos una opcion.</span>";
        return 1;
    }
...
function validateClasificacionPEGI() {
    ...
    if (!flag) {
        let inputClasificacionPEGI = document.querySelector(
            "#input__clasificacionContainer"
        );
        inputClasificacionPEGI.innerHTML =
            "<span class=errorMessage>Debe seleccionar al menos una opcion.</span>";
        return 1;
    }
...
function validateClasificacionESRB() {
    ...
    if (!flag) {
        let inputClasificacionESRB = document.querySelector(
            "#input__clasificacionContainer"
        );
        inputClasificacionESRB.innerHTML =
            "<span class=errorMessage>Debe seleccionar al menos una opcion.</span>";
        return 1;
    }
...
function validatePrice() {
    ...
    if (!expReg.test(precio.value)) {
        ...
        inputPrecio.innerHTML =
            "<span class=errorMessage>Debe ingresar un valor numerico.</span>";
        return 1;
    }
...
function validateTriller() {
    ...
    if (triller.value.length < 3 || triller.value.length > 50) {
        ...
        inputTriller.innerHTML =
            "<span class=errorMessage>Debe tener entre 3 y 50 caracteres.</span>";
        return 1;
    }
