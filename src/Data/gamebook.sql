...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-12-2023 a las 22:54:44
...
CREATE TABLE `product` (
  ...
  `gameplay_image` varchar(150) NOT NULL,
...
CREATE TABLE `user` (
  ...
  `password_hash` varchar(100) NOT NULL,
  `avatar` varchar(150) NOT NULL DEFAULT 'monster0.png',
